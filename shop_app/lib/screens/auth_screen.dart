  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (err.toString().contains('EMAIL_EXISTS')) {
        ...
        errMsg = 'Couldn\'t find a user with that email!';
      } else if (err.toString().contains('INVALID_PASSWORD')) {
        errMsg = 'Invalid password!';
      }
      //print('submit err ${err.toString()}');
      _showErrorDialog(errMsg);
    } catch (err) {
      //print('submit catch err ${err.toString()}');
      const errMsg = 'Couldn\'t authenticate you. Please try again later!';
      _showErrorDialog(errMsg);
    }
